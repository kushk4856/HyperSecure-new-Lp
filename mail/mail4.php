...
if (isset($_POST['submit'])) {
    ...
    $email_subject = "Query from Hyper Secure Long LP (Top Form)";

    // validation expected data exists
    if (!isset($_POST['name']) || !isset($_POST['phone']) || !isset($_POST['email']) || !isset($_POST['company_size'])) {
    ...
    // $email_message .= "Clinic Name: " . clean_string($clinic) . "\n";
