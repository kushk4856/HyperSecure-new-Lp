...
if (isset($_REQUEST['submit'])) {
    ...
    $email_subject = "Query from Hyper Secure Long LP (Bottom Form)";

    // validation expected data exists
    if (!isset($_POST['name']) || !isset($_POST['company_name']) || !isset($_POST['email']) || !isset($_POST['phone']) || !isset($_POST['location']) || !isset($_POST['company_size'])) {
